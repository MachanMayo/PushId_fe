      ...
      */}
      <div className="hidden lg:flex lg:w-[55%] relative items-center justify-center bg-[#0B0E14] overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Gradient Overlay identik dengan Register */}
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center px-6 py-12 bg-[#020617] relative z-20 h-full overflow-y-auto">
        ...
        {/* CONTAINER PEMBATAS LEBAR (Max Width 420px - Sama dengan Register) */}
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-white tracking-wide text-center mt-2 uppercase">
              Welcome Back!
            </h2>
          </div>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between pt-2">
               {/* Remember Me - Style checkbox sama dengan Terms & Conditions di Register */}
            ...
            {/* Button Log in */}
            {/* Menggunakan <a> ke /lobby untuk simulasi navigasi di preview */}
            <a href="/lobby" className="block w-full pt-2">
                <button 
                    type="submit" 
                    className="w-full bg-[#5C5CFF] hover:bg-[#4848d1] text-white font-bold py-3.5 rounded-xl shadow-[0_0_20px_rgba(92,92,255,0.4)] hover:shadow-[0_0_25px_rgba(92,92,255,0.6)] transition-all duration-300 transform active:scale-[0.98] mt-2"
                >
                  Log in
                </button>
            </a>
